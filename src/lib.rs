...
pub fn arith_demo() -> Result<(), Box<dyn Error>> {
    ...
    //  Global Scope
    #[cfg(feature = "sc_A")]
    let par = &params::PARM90__PI_2__D_02__A;
    #[cfg(feature = "sc_B")]
    let par = &params::PARM90__PI_2__D_03__B;
    #[cfg(feature = "sc_C")]
    let par = &params::PARM90__PI_3__D_19__C;
    #[cfg(feature = "sc_D")]
    let par = &params::PARM90__PI_3__D_12__D;
    #[cfg(feature = "sc_E")]
    let par = &params::PARM90__PI_4__D_12__E;
    #[cfg(feature = "sc_F")]
    let par = &params::PARM90__PI_5__D_20__F;
    #[cfg(feature = "sc_G")]
    let par = &params::PARM90__PI_4__D_36__G;
    #[cfg(feature = "sc_H")]
    let par = &params::PARM90__PI_5__D_36__H;
    #[cfg(feature = "sc_I")]
    let par = &params::PARM90__PI_7__D_74__I;
...
pub fn nn_demo() -> Result<(), Box<dyn Error>> {
    ...
    //  C: Evaluation
        ...
        simple_duration!(
            ["NN eval"],
            [
    let c_out       = arythmia_nn().eval(&pc, &c_in);   // demo_nn   arythmia_nn
            ]
        );
    //DBG
    println!("In plain domain:");
        simple_duration!(
            ["NN eval (plain)"],
            [
    let m_out_plain = arythmia_nn().eval(&pc, &m_in);
            ]
        );
...
/// Get a real-world neural network for arythmia classification
pub fn arythmia_nn() -> NeuralNetwork {
    NeuralNetwork {
        layers: vec![
            vec![
            ...
            vec![
                Perceptron {t: PercType::LIN, w: vec![-615, 263, 580, -177, 465, 577, -527, -336, -460, 295, 736, -981, -838, 484, -72, -738, -604, -741, 10, 300, 293, 215, -1064, 15, -1007, -188, -1061, -261, 225, 123, 680, 397, 179, 307, -246, -192, -814, 448], b: 822434697576448i64},
                Perceptron {t: PercType::LIN, w: vec![404, -1123, -124, -388, 154, -240, 206, 13, 57, -667, 212, -368, -10, -530, -2444, 269, 400, 140, 166, 25, -651, -328, -4, -98, -4093, -1958, 434, 399, -89, 217, -539, -547, -103, 345, -692, -231, -527, 820], b: 29961691856896i64},
                Perceptron {t: PercType::LIN, w: vec![-226, -223, 418, -482, -84, 118, -47, 276, 902, 695, -423, -785, 688, 908, 136, -601, -211, 28, -872, -3186, -608, 177, 147, 727, -53, -339, 2, 197, -814, -1400, 81, -2926, 241, 111, -590, 613, 194, 78], b: -450799767388160i64},
                Perceptron {t: PercType::LIN, w: vec![-519, -2467, -404, -1478, -2932, 127, 465, -1091, -375, 93, 680, -875, 324, 104, 188, 220, 193, -999, -1704, 404, 374, -1, -2183, -539, 388, 409, -2485, 258, -1245, -906, -7, 251, 360, -732, -1633, -141, -984, 360], b: -831230790598656i64},
                Perceptron {t: PercType::LIN, w: vec![-25, -177, -342, 481, -1381, 100, -318, 132, -334, 235, 124, -1344, -946, 223, -48, -1292, -1793, 248, 516, -925, -1107, 280, -752, -1690, 456, -263, -43, 687, -758, 25, -106, -93, 434, -299, -1354, 255, 307, 182], b: -694891348754432i64},
                Perceptron {t: PercType::LIN, w: vec![-1671, -1853, 11, -573, -154, -128, 604, -2860, -3195, 172, -398, 924, -268, 51, -8, -1396, -1284, -71, 145, -414, 136, -2041, 220, 243, 513, -205, -606, -311, 26, -452, -1624, 8, -565, -176, 211, 168, 284, -649], b: -888405395243008i64},
                Perceptron {t: PercType::LIN, w: vec![-792, -7717, -681, 362, -265, -386, 382, 286, 195, -2614, -533, 259, -270, 534, -122, 597, 392, -312, 616, 368, 632, -384, -79, 0, 778, 40, -408, -412, -40, -1077, -93, 1236, -479, 217, 678, 27, -840, 144], b: -186916976721920i64},
                Perceptron {t: PercType::LIN, w: vec![377, -2930, -809, 427, 767, 267, 332, 187, 408, -23, -574, -838, -275, 319, -515, -369, 41, -3256, -541, 346, 934, -1248, 295, -77, -293, -1621, 65, 602, -55, -402, -197, -1001, -406, 132, 1014, 300, -126, -125], b: -1574500650975232i64},
                Perceptron {t: PercType::LIN, w: vec![315, -888, -4, 1160, 778, -288, -136, 55, 425, -217, -1, -162, -1346, 372, -708, -1792, -1, 0, -429, -610, -511, 428, 189, -386, 25, 205, 342, 53, 218, 73, 307, -357, -109, 149, -478, 875, -1597, 365], b: 1706442046308352i64},
                Perceptron {t: PercType::LIN, w: vec![-206, 169, -1167, -30, 154, 223, -1750, -11, -2434, 122, 120, 40, -231, -295, 115, -186, -133, 52, 127, 467, -495, 770, -100, -1737, -1095, -311, -91, 325, -49, -470, -1336, 418, 697, -210, -1576, -988, -124, 917], b: 598134325510144i64},
                Perceptron {t: PercType::LIN, w: vec![-2574, 150, -1189, -816, -963, -31, 249, 27, -307, 657, -470, -948, -1000, 196, 249, -2730, 540, 165, 538, -1110, -464, -734, -521, 157, 859, 287, 919, 2, -324, 599, -165, -1025, 834, -328, 316, 1540, 154, 117], b: 818036651065344i64},
                Perceptron {t: PercType::LIN, w: vec![127, -2362, -732, -461, -361, -404, 254, 445, 261, -987, -841, -197, -608, -1459, 437, 456, -240, -1632, 549, -2202, -1136, 141, 427, 106, -111, 145, -609, -1530, -1269, 837, 138, -5, -207, -459, 311, -121, -474, 336], b: -1337006139375616i64},
                Perceptron {t: PercType::LIN, w: vec![-686, 570, 362, 532, -777, 188, 374, -467, -313, 292, -111, -376, 965, -1389, -1414, -435, 810, 491, -449, 82, 56, -194, 108, 455, 266, -283, 45, 278, 326, -170, 235, 104, -690, 736, -259, -118, -2024, 337], b: 354042744143872i64},
                Perceptron {t: PercType::LIN, w: vec![116, -229, -170, 419, -143, 163, -4, -321, -1494, -60, -673, 173, -1761, 297, 1584, 220, -573, 206, 217, -726, 98, -564, -582, 711, 47, -143, -1705, -317, -354, -3498, -366, 514, 537, -3374, -160, 143, 35, 839], b: -1266637395197952i64},
                Perceptron {t: PercType::LIN, w: vec![917, 140, 79, 73, -95, -836, -425, 463, -2951, -108, 606, 515, -604, -264, 10, 1089, 323, -698, 291, 270, 92, 398, -857, -511, -687, 228, 116, 162, 129, -751, 578, -773, 1093, 139, -393, 427, 117, -649], b: 606930418532352i64},
                Perceptron {t: PercType::LIN, w: vec![189, -772, 434, 314, -39, -487, -175, -225, 264, -1336, -861, -157, -119, 361, 403, -112, 134, -58, 66, -113, 136, -776, 300, -1854, 193, 387, 400, 190, -111, 63, -937, 193, -1, -839, -34, -173, -221, -1085], b: -137438953472000i64},
            ],
        ],
    }
}
